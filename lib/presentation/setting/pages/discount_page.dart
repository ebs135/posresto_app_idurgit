...
class DisccountPage extends StatefulWidget {
  const DisccountPage({super.key});

  @override
  State<DisccountPage> createState() => _DisccountPageState();
}

class _DisccountPageState extends State<DisccountPage> {
